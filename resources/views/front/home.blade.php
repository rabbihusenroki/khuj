            ...
            <div class="col-md-12">
                <div class="item">
                    <div class="text">
                        ...
                        <button class="share-btn btn btn-primary" onclick="shareOnFacebook()"><i class="fab fa-facebook"></i> Share on Facebook</button>
                        <button class="share-btn btn btn-primary" onclick="shareOnTwitter()"><i class="fab fa-twitter"></i> Share on Twitter</button>
                    </div>      
                    <div class="search-section" style="background: linear-gradient(to bottom, rgba(0, 0, 0, 0.7) 0%, rgba(0, 0, 0, 0) 100%);">
                        <form action="{{ url('job-listing') }}" method="get">
                            <div class="inner">
                                <div class="row">
                                    <div class="col-lg-3">
                                        <div class="form-group" style="box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
                                            <input type="text" name="title" class="form-control form-border" placeholder="{{ $home_page_data->job_title }}" 
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group" style="box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
                                            <select name="category" class="form-select select2 form-border">
                                    ...
                                    <div class="col-lg-3">
                                        <div class="form-group" style="box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);" >
                                            <select name="location" class="form-select select2 form-border">
                                    ...
                                    <div class="col-lg-3" style="box-shadow: 0 2px 5px rgba(0, 0, 0, 0.1);">
