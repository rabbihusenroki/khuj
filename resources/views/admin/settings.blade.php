                ...
                <div class="card-body">
                    <form action="{{ route('admin_settings_update') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="theme_color_1" value="{{ $settings->theme_color_1 }}">
                        </div>

                        <div class="form-group mb-3">
                            <label>Theme Color 2</label>
                            <input type="text" class="form-control" name="theme_color_2" value="{{ $settings->theme_color_2 }}">
                        </div>
